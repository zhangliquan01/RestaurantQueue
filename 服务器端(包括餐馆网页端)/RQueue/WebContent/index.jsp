...
<%
	// Get restaccountid
	String restaccountid = null;
	String errorcode = null;
	try{
		restaccountid  = ActionContext.getContext().getSession().get("userid").toString();
		// Get ErrorCode
		errorcode = ActionContext.getContext().getSession().get("error").toString();
	}catch(Exception e){
