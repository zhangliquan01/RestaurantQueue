...
<%
	// Get ErrorCode
	String errorcode = ActionContext.getContext().getSession().get("error").toString();
 %>
	...
	<div class="container">
		<div class="login-page">
			   ...
			   <div class="col-md-6 login-left wow fadeInLeft" data-wow-delay="0.4s">
			  	 <h3>NEW RESTAURANT USERS</h3>
				 <p>By creating an account with your store, you will be able to move through the checkout process faster, monitor queue list, view and track your orders faster and better.</p>
				 <a class="acount-btn" href="website/register">Create an Account</a>
			   </div>
			   <div class="col-md-6 login-right wow fadeInRight" data-wow-delay="0.4s">
			  	<h3>REGISTERED RESTAURANT USERS</h3>
				<p>If you have an account with us, please log in.</p>
				<% if (errorcode.equals("0")) {%>
				<p>Sorry, no such User</p>
				<%} else if (errorcode.equals("-1")) {%>
				<p>Sorry, login failed.</p>
				<%} else if (errorcode.equals("-2")) { %>
				<p>Sorry, a system error occured. Please try again later.</p>
				<%} else if (errorcode.equals("-3")) {%>
				<p>Sorry, it cannot be empty.</p>
				<%} %>
...
<div class="clearfix"></div>
	...
	<div class="footer">
		<div class="container">
			<p class="wow fadeInLeft" data-wow-delay="0.4s">Copyright &copy; 2014.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
		</div>
	</div>
	<!-- footer-section-ends -->
	  <script type="text/javascript">
