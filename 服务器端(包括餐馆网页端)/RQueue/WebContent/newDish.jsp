		  	  ...
		  	  <form method="post"> 
				 <!-- <div class="register-top-grid"> -->
					...
					<div class="col-md-6 login-right wow fadeInRight">
						...
						<p>Sorry, create operation failed. Please check your typing.</p>
						<%} else if (errorcode.equals("-2")) { %>
						<p>Sorry, a system error occurred. Please try again later.</p>
						...
						<div class="wow fadeInLeft" data-wow-delay="0.4s">
							<span>Groups<label>*</label></span>
							<input type="text" name="groups">
						</div>
						<div class="wow fadeInRight" data-wow-delay="0.4s">
							<span>Depiction<label>*</label></span>
